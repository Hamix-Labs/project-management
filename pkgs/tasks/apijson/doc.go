...
// cycle-safe error-detail helpers (InvalidInputDetail, ConflictDetail) shared by
// pkgs/tasks/httperr and BC handlers without importing pkgs/tasks/handlerhttp.
//
