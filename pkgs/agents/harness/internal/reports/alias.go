...
var (
	...
	WritePullRequestReport          = sidecar.WritePullRequestReport
	ParsePullRequestReport          = sidecar.ParsePullRequestReport
	...
	RequirePullRequestSubmitReceipt = sidecar.RequirePullRequestSubmitReceipt
	PullRequestReportPath           = sidecar.PullRequestReportPath
	PullRequestSubmitReceiptPath    = sidecar.PullRequestSubmitReceiptPath
)

type PullRequestReport = sidecar.PullRequestReport
