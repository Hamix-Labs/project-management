...
type TaskCycleVerifyReport struct {
	...
	VerifierKind checklistdomain.VerifierKind `gorm:"not null;default:''"`
	...
	Criterion *checklistmodel.TaskChecklistItem `gorm:"foreignKey:CriterionID;references:ID;constraint:OnDelete:NO ACTION"`
}
