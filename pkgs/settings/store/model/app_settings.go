...
type AppSettings struct {
	...
	StreamIdleStuckSeconds     int            `gorm:"not null;default:900;check:chk_app_settings_stream_idle_stuck_seconds,stream_idle_stuck_seconds >= 0"`
	AgentTaskParallelism       int            `gorm:"not null;default:150;check:chk_app_settings_agent_task_parallelism,agent_task_parallelism >= 1"`
