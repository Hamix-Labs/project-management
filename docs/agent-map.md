...
| Agent harness | `pkgs/agents/harness/` | Execute/verify loop (same runner), criteria, git integrity, command-only verify (ADR-0090) | [domain/harness.md](./domain/harness.md), [domain/verify-agent.md](./domain/verify-agent.md), [ADR-0090](./adr/ADR-0090-command-only-verify.md), [cursor-session-resume.md](./domain/cursor-session-resume.md) |
