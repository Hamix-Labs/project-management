...
| Draft assist | `pkgs/draftassist/`, `cmd/hamix-draft-mcp` | Compose-page AI sessions, SSE, fake runner, prompt MCP tools | [domain/draft-assist.md](./domain/draft-assist.md), [ADR-0101](./adr/ADR-0101-draft-assist-platform.md) |
