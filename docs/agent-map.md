...
| Agent harness | `pkgs/agents/harness/` | Execute/verify one-shot loop (same runner), criteria, git integrity, command-only verify ([ADR-0090](./adr/ADR-0090-command-only-verify.md)) | [domain/harness.md](./domain/harness.md), [domain/verify-agent.md](./domain/verify-agent.md), [execute-and-verify.md](./execute-and-verify.md), [cursor-session-resume.md](./domain/cursor-session-resume.md) |
