...
| Persistence | `pkgs/tasks/store/`, `pkgs/projects/store/`, `pkgs/gitinventory/store/`, `pkgs/settings/store/`, `pkgs/tasks/postgres/` | Store facade, GORM migrate, dual-write to `task_events` | [domain/persistence.md](./domain/persistence.md), [store/README.md](../pkgs/tasks/store/README.md) |
