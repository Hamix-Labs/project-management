...
| Draft assist | `pkgs/draftassist/`, `cmd/hamix-draft-mcp` | Compose-page AI sessions, SSE, SDK sidecar (fake runner is tests-only), prompt MCP tools | [domain/draft-assist.md](./domain/draft-assist.md), [ADR-0101](./adr/ADR-0101-draft-assist-platform.md) |
...
| Persistence | `internal/taskapi/composition`, BC `pkgs/*/store/`, `pkgs/tasks/postgres/` | Composition root wires BC stores; GORM migrate orchestration; dual-write to `task_events` | [domain/persistence.md](./domain/persistence.md), [ADR-0079](./adr/ADR-0079-facade-deletion.md) |
...
| Agent harness | `pkgs/agents/harness/` | Execute + claim acceptance one-shot loop ([ADR-0092](./adr/ADR-0092-execute-owns-verify-commands.md)) | [domain/harness.md](./domain/harness.md), [domain/verify-agent.md](./domain/verify-agent.md), [execute-and-verify.md](./execute-and-verify.md), [cursor-session-resume.md](./domain/cursor-session-resume.md) |
...
| Cycle commits | `harness/internal/git/commits.go`, `store/internal/commits/`, `sidecar/commit_register.go` | MCP commit register ledger for verify | [cycle-commits.md](./domain/cycle-commits.md), [ADR-0093](./adr/ADR-0093-mcp-commit-register.md) |
...
| Repositories / worktrees | `web/src/worktrees/` | `/repositories` SPA vertical — register repos (legacy `/worktrees` redirects) | [web.md](./web.md) §Routes, [domain/worktrees-and-branches.md](./domain/worktrees-and-branches.md) |
