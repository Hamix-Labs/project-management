...
func TestHTTP_taskEvents_fullListShape(t *testing.T) {
	...
	defer srv.Close()
	created := handlertest.PostTaskJSON(t, srv, `{"title":"contract","priority":"medium"}`, http.StatusCreated)
...
func TestHTTP_taskEvents_cursorShape(t *testing.T) {
	srv, _ := handlertest.NewCreateServerWithStore(t)
	defer srv.Close()
	task := handlertest.PostTaskJSON(t, srv, `{"title":"c","priority":"medium"}`, http.StatusCreated)
	handlertest.PatchTaskJSON(t, srv, task.ID, `{"title":"c2"}`, http.StatusOK)
...
func TestHTTP_taskEvents_orderingFullVsCursor(t *testing.T) {
	srv, _ := handlertest.NewCreateServerWithStore(t)
	defer srv.Close()
	task := handlertest.PostTaskJSON(t, srv, `{"title":"o","priority":"medium"}`, http.StatusCreated)
	for i := 0; i < 3; i++ {
		handlertest.PatchTaskJSON(t, srv, task.ID, `{"title":"o-`+string(rune('a'+i))+`"}`, http.StatusOK)
	}
...
func TestHTTP_taskEvents_validation400s(t *testing.T) {
	srv, _ := handlertest.NewCreateServerWithStore(t)
	defer srv.Close()
	task := handlertest.PostTaskJSON(t, srv, `{"title":"v","priority":"medium"}`, http.StatusCreated)
...
func TestHTTP_taskEvents_seqPathValidation(t *testing.T) {
	srv, _ := handlertest.NewCreateServerWithStore(t)
	defer srv.Close()
	task := handlertest.PostTaskJSON(t, srv, `{"title":"s","priority":"medium"}`, http.StatusCreated)
...
func TestHTTP_taskEvents_patchValidation(t *testing.T) {
	...
	defer srv.Close()
	task := handlertest.PostTaskJSON(t, srv, `{"title":"p","priority":"medium"}`, http.StatusCreated)
