...
func TestHTTP_repo_search_and_create_rejects_bad_file_mention(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoSearchWithWorktree(wtID, "note"))
	if err != nil {
		t.Fatal(err)
	}
	...
	longQ := strings.Repeat("a", repohandler.MaxSearchQueryBytes+1)
	resLong, err := http.Get(srv.URL + handlertest.RepoSearchWithWorktree(wtID, longQ))
	if err != nil {
		t.Fatal(err)
	}
...
func TestHTTP_repo_file_ok(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoPathWithWorktree(wtID, "note.txt"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_file_and_validate_range_reject_overlong_path(t *testing.T) {
	...
	longPath := strings.Repeat("a", repohandler.MaxRelPathQueryBytes+1)
	resFile, err := http.Get(srv.URL + handlertest.RepoPathWithWorktree(wtID, longPath))
	if err != nil {
		t.Fatal(err)
	}
	...
	resVal, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, longPath, "1", "1"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestHTTP_repo_validate_range_ok(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "note.txt", "1", "2"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_validate_range_missing_params(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "", "", ""))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_validate_range_reject_overlong_start_end(t *testing.T) {
	...
	long := strings.Repeat("1", repohandler.MaxLineQueryParamBytes+1)
	res, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "note.txt", long, "1"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
	...
	res2, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "note.txt", "1", long))
	if err != nil {
		t.Fatal(err)
	}
	defer res2.Body.Close()
...
func TestHTTP_repo_file_resolve_error_doesNotLeakInternalPrefix(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoPathWithWorktree(wtID, "foo/.."))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_validate_range_resolve_error_doesNotLeakInternalPrefix(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "foo/..", "1", "1"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_validate_range_invalid_start_end(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoValidateRangeWithWorktree(wtID, "a.txt", "nope", "1"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_routes_require_worktree_id(t *testing.T) {
	dir := t.TempDir()
	srv, _, _ := handlertest.NewBoundRepoServer(t, dir)
	defer srv.Close()
...
func TestHTTP_repo_diff_ok(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoDiffWithWorktree(wtID, sha))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_diff_not_found(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoDiffWithWorktree(wtID, "deadbeef"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
...
func TestHTTP_repo_diff_invalid_sha(t *testing.T) {
	...
	res, err := http.Get(srv.URL + handlertest.RepoDiffWithWorktree(wtID, "not-a-sha"))
	if err != nil {
		t.Fatal(err)
	}
	defer res.Body.Close()
