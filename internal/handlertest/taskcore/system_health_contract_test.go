...
func TestHTTP_systemHealth_envelopeShape(t *testing.T) {
	...
	raw, _ := handlertest.MustGetJSON(t, srv.URL, "/system/health")
...
func TestHTTP_systemHealth_populated(t *testing.T) {
	...
	raw, res := handlertest.MustGetJSON(t, srv.URL, "/system/health")
...
func TestHTTP_systemHealth_agentPaused(t *testing.T) {
	...
	rawDefault, _ := handlertest.MustGetJSON(t, srv.URL, "/system/health")
	...
	rawPaused, _ := handlertest.MustGetJSON(t, srv.URL, "/system/health")
...
func TestHTTP_systemHealth_doesNotPublishSSE(t *testing.T) {
	...
	handlertest.MustEqualEvents(t, "GET /system/health", got, []string{})
}
