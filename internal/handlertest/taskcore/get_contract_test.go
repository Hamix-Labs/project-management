...
func TestHTTP_getTask_flatTaskEnvelope(t *testing.T) {
	...
	wantKeys := []string{"created_at", "cursor_model", "id", "initial_prompt", "number", "pickup_not_before", "priority", "project_id", "repository_id", "runner", "runner_config", "status", "title", "worktree_id"}
