...
export function deleteNodeAtPosition(
  ...
  // Fallback
  return editor.chain().focus().setNodeSelection(pos).deleteSelection().run()
}
...
export function useDeleteNode(config?: UseDeleteNodeConfig) {
  ...
  useHotkeys(
    ...
    },
    {
      ...
      // Editor extensions own shortcuts they already handled. The shared
      // delete action remains available for every unhandled Backspace.
