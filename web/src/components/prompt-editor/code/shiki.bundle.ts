...
/**
 * Same language set as `@blocknote/code-block`, plus Go.
 * Themes: github-light only so prosemirror-highlight's first-theme pick stays legible.
 */
...
export function createPromptCodeHighlighter(): Promise<Highlighter> {
  return createHighlighterFactory({
    themes: ["github-light"],
    langs: [],
