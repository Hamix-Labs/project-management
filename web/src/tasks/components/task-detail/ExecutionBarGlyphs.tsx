/** Inline SVG glyphs for the task-detail execution bar chips. */
...
export function CoinsGlyph({ className }: GlyphProps) {
  return (
    ...
    >
      ...
      <path d="M7 6h1v4" />
      <path d="M16.71 13.88A6 6 0 0 0 13 11.12" />
    </svg>
  );
}
...
export function MessagesSquareGlyph({ className }: GlyphProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function GitBranchGlyph({ className }: GlyphProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function HashGlyph({ className }: GlyphProps) {
  return (
    <svg
      className={className}
      width="16"
